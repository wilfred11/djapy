...
var configBasic = Object.assign({}, config, {
  ...
  plugins: [].concat(
    new CleanWebpackPlugin({dangerouslyAllowCleanPatternsOutsideProject: true, dry:false, cleanOnceBeforeBuildPatterns: [
      'static/djapy_app/basic/css/**',
      'static/djapy_app/dt/css/**'
    ],}),
