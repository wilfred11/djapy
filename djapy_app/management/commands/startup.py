...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        management.call_command(reset_db.Command(), "--close-sessions", verbosity=1, interactive=False)
        ...
        self.stdout.write("Please enter an e-mailaddress and password. These will be used to create superuser.")
